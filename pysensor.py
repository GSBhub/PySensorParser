...
def main ():
    ...
    parser.add_argument('-s', '--settings', metavar='settings', default="parser_settings.json", type=str,
                    help='Specify Settings Filename')

    parser.add_argument('-l', '--long-output', metavar='long-output', default="parser_settings.json", type=str,
                    help='Extended JSON Output (contains feature vectors)')
